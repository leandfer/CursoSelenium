...
public class TesteFrame {
	...
	public void deveInteragirComJanalasSemTitulos() {
		...
		//abre a nova janela e pega o id da pagina que abriu "getWindowHandles().toArray()[1]"		
		driver.switchTo().window((String)driver.getWindowHandles().toArray()[1]);
		driver.findElement(By.tagName("textarea")).sendKeys("Ola Mundo");
		
		//volta para a pagina que estava
		driver.switchTo().window((String)driver.getWindowHandles().toArray()[0]);
		driver.findElement(By.tagName("textarea")).sendKeys("Como Foi");
